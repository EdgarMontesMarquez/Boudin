...
Backend
    ...
    MySQL: es un sistema de gestión de bases de datos relacional (RDBMS) de código abierto. Apache: Apache es un servidor web de código abierto que permite servir contenido a través de la web.
